...
namespace Com.Enterprisecoding.RobosapienKinect {
    public partial class MainWindow : Window {
        ...
        private readonly GestureCommandBase[] gestureCommands = new GestureCommandBase[] {
        ...
        private readonly Dictionary<string, VoiceCommandBase> voiceCommands = new Dictionary<string, VoiceCommandBase> {
        ...
        public MainWindow() {
            ...
            RoboManager roboManagerInstance = RoboManager.Instance;
...
Ensure you have the Microsoft Speech SDK installed and configured.",
            ...
            commands.Add("robo");
            foreach (VoiceCommandBase command in voiceCommands.Values) {
        ...
        private void sre_SpeechRecognized(object sender, SpeechRecognizedEventArgs e) {
            ...
            string command = e.Result.Text.ToUpperInvariant();
        ...
        private void kinectSensor_SkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e) {
            using (SkeletonFrame skeletonFrame = e.OpenSkeletonFrame()) {
                ...
                foreach (Skeleton skelaton in skeletonData.Where(skelaton => skelaton.TrackingState == SkeletonTrackingState.Tracked)) {
                    foreach (GestureCommandBase gestureCommand in gestureCommands.Where(gestureCommand => gestureCommand.ShouldHandle(skelaton.Joints))) {
