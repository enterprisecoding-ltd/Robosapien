...
namespace UsbUirt {
    ...
    public sealed class Controller : IDisposable {
        ...
        private static readonly TimeSpan _defaultInactivityWaitTime = TimeSpan.FromMilliseconds(50);
        private static readonly uint _drvVersion;

        private readonly DateTime _firmwareDate;
        private readonly uint _firmwareVersion;
        private readonly object _learnCompletedSyncRoot = new object();
        private readonly Hashtable _learnStates;
        private readonly object _learningSyncRoot = new object();
        private readonly uint _protocolVersion;
        private readonly object _receivedSyncRoot = new object();
        private readonly object _transmitCompletedSyncRoot = new object();
...
//	hDrvHandle = (IntPtr)INVALID_HANDLE_VALUE;
        ...
        /// </summary>
        /// <returns>
        ///     On success, a handle to be used in subsequent calls to USB-UIRT
        ///     functions. On failure, INVALID_HANDLE_VALUE.
        /// </returns>
        ...
        /// <returns>TRUE on success</returns>
        /// <remarks>
        ///     Using this API call is optional and is only needed to support
        ///     changing USB-UIRT's private preferences
        /// </remarks>
        [DllImport("uuirtdrv.dll", SetLastError = true)]
        ...
        ///     format specifier which identifies the format of the IRCode
        ...
        ///     IR code -- normally pass 0 for this parameter
        /// </param>
        /// <param name="hEvent">
        ///     optional event handle which is obtained by a call to
        ...
        ///     completed transmission this event will be signalled by the driver
        /// </param>
        ...
        /// </param>
        /// <param name="IRCode">
        ///     the learned IR code (upon return). It is the responsibility
        ///     of the caller to allocate space for this string; suggested string size is at
        ///     least 2048 bytes
        /// </param>
        /// <param name="progressProc">
        ///     a caller-supplied callback function which will be called
        ...
        /// </param>
        /// <param name="userData">
        ///     will be passed by the USB-UIRT driver to any calls of
        ///     progressProc.
        /// </param>
        /// <param name="pAbort">
        ...
        /// </param>
        /// <param name="param1">
        ///     currently used only when the codeFormat
        ///     includes the UUIRTDRV_IRFMT_LEARN_FORCEFREQ flag (not normally needed) -- in which
        ///     case param1 should indicate the forced carrier frequency
        /// </param>
        /// <param name="reserved0">reserved for future expansion; should be NULL</param>
        /// <param name="reserved1">reserved for future expansion; should be NULL</param>
        /// <returns>TRUE on success</returns>
        /// <remarks>
        ///     The IR code learned  will be a complete IR stream suitable for subsequent
        ...
        ///     is often too limiting, although it does produce the smallest codes.
        /// </remarks>
        [DllImport("uuirtdrv.dll", SetLastError = true)]
        ...
        /// </remarks>
        /// <param name="hDrvHandle">Handle to to USB-UIRT returned by UUIRTOpen</param>
        /// <param name="receiveProc">
        ///     the address of a
        ///     PUUCALLBACKPROC function
        /// </param>
        /// <param name="userData">
        ///     a general-purpose
        ///     32-bit value supplied by the caller to UUIRTSetReceiveCallback. This parameter
        ///     is useful for carrying context information, etc. Will be passed to receiveProc.
        /// </param>
        /// <returns>TRUE on success</returns>
        [DllImport("uuirtdrv.dll", SetLastError = true)]
